...
| 7  | Password security         | Entropy bound, attacker-rate table, a timed dictionary attack over fast vs memory-hard hashes, PBKDF2/scrypt/Argon2id | RFC 8018, RFC 7914, RFC 9106 |
...
| 11 | Encodings                 | Base64, Base64url, hex, percent, binary; code-point and UTF-8 byte view                       | RFC 4648                         |
| 12 | Benchmark                 | Identical chained SHA-256 workload in WebAssembly, JavaScript and WebCrypto                   | —                                |
